package theplaceholder.characters;
...
import static theplaceholder.PlaceholderMod.*;

//Wiki-page https://github.com/daviscook477/BaseMod/wiki/Custom-Characters
//and https://github.com/daviscook477/BaseMod/wiki/Migrating-to-5.0
//All text (starting description and loadout, anything labeled TEXT[]) can be found in PlaceholderMod-character-Strings.json in the resources

public class PlaceholderCharacter extends CustomPlayer {
...
//        @SpireEnum(name = "THE_PLACEHOLDER_GRAY") // These two HAVE to have the same absolutely identical name.
//        public static AbstractCard.CardColor THE_PLACEHOLDER_GRAY;
        @SpireEnum(name = "THE_PLACEHOLDER_GRAY") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType THE_PLACEHOLDER_GRAY;
    }
    ...
    private static final String ID = makeID("ThePlaceholder"); // needs to be the key from CharacterStrings.json
    ...
    private static String getCharacterOrbImagePath(String filename) {
        return getImageResourcePath("char/defaultCharacter/orb/" + filename);
    }
    ...
    public PlaceholderCharacter(String name, PlayerClass setClass) {
//        super(name, setClass, orbTextures, getEnergyOrbFilePath(),null, (String) null);
    ...
    public AbstractCard.CardColor getCardColor() {
        return AbstractCardEnum.THE_PLACEHOLDER_GRAY;
    }
    ...
    public AbstractPlayer newInstance() {
        return new PlaceholderCharacter(name, chosenClass);
    }
