package theplaceholder.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import theplaceholder.cards.AbstractDefaultCard;

import static theplaceholder.PlaceholderMod.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "PlaceholderCharacter:" (or, your id) before the name.
    }
