...
public class DefaultCommonAttack extends CustomCard {
    ...
    // The list of all of them can be found in the main PlaceholderMod.java file in the
    ...
    // Go check out DefaultAttackWithVariable and PlaceholderCharacter.variable.DefaultCustomVariable
