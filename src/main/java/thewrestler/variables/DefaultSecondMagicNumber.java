package thewrestler.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import thewrestler.cards.AbstractDefaultCard;

import static thewrestler.WrestlerMod.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "WrestlerCharacter:" (or, your id) before the name.
    }
