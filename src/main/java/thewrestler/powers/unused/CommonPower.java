...
import static thewrestler.WrestlerMod.makePowerPath;
...
public class CommonPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = WrestlerMod.makeID("CommonPower");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("wrestler_power84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("wrestler_power32.png"));
