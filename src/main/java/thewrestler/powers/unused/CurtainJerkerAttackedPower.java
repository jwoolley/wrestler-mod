...
public class CurtainJerkerAttackedPower extends AbstractWrestlerPower implements CloneablePowerInterface {
  public static final String POWER_ID = WrestlerMod.makeID("CurtainJerkerAttackedPower");
  public static final String IMG = "curtainjerkerattecked.png";
  ...
  public CurtainJerkerAttackedPower(AbstractCreature owner, int amount) {
  ...
  public AbstractPower makeCopy() {
    return new CurtainJerkerAttackedPower(owner, amount);
  }
