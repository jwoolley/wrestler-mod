...
public class DefaultCommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = WrestlerMod.makeID(DefaultCommonPower.class.getSimpleName());
    ...
    public static final CardColor COLOR = AbstractCardEnum.THE_WRESTLER_GRAY;
    ...
    // Go check out DefaultAttackWithVariable and WrestlerCharacter.variable.DefaultCustomVariable
