...
public class KneedAFriend extends CustomCard {
  public static final String ID = WrestlerMod.makeID("KneedAFriend");
  public static final String NAME;
  public static final String DESCRIPTION;
  public static final String[] EXTENDED_DESCRIPTION;
  public static final String IMG_PATH = "kneedafriend.png";
