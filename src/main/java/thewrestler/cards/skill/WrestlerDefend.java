...
public class WrestlerDefend extends AbstractDynamicCard {
    ...
    public static final String ID = WrestlerMod.makeID(WrestlerDefend.class.getSimpleName());
