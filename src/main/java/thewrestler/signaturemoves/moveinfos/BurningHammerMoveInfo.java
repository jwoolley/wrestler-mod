...
public class BurningHammerMoveInfo extends AbstractSignatureMoveInfo {
  private static final int NUM_CARDS_REQUIRED = 5;
  private int numCardsExhausted = 0;
  private boolean alreadyGainedThisCombat;

  public BurningHammerMoveInfo() {
    this(SignatureMoveUpgradeList.NO_UPGRADES, true);
  }

  public BurningHammerMoveInfo(SignatureMoveUpgradeList upgradeList, boolean isFirstInstance) {
    super(new BurningHammer(), upgradeList, isFirstInstance);
  }
