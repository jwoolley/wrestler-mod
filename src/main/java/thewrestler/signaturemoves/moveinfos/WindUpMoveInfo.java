...
public class WindUpMoveInfo extends AbstractSignatureMoveInfo {
  private static final int NUM_CARDS_REQUIRED = 5;
  private int numCardsExhausted = 0;
  private boolean alreadyGainedThisCombat;

  public WindUpMoveInfo() {
    this(SignatureMoveUpgradeList.NO_UPGRADES, true);
  }

  public WindUpMoveInfo(SignatureMoveUpgradeList upgradeList, boolean isFirstInstance) {
    super(new WindUp(), upgradeList, isFirstInstance);
  }
