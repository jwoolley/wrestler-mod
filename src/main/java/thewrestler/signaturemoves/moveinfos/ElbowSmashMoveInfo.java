...
public class ElbowSmashMoveInfo extends AbstractSignatureMoveInfo {
  private static final int NUM_CARDS_REQUIRED = 5;
  private int numCardsExhausted = 0;
  private boolean alreadyGainedThisCombat;

  public ElbowSmashMoveInfo() {
    this(SignatureMoveUpgradeList.NO_UPGRADES, true);
  }

  public ElbowSmashMoveInfo(SignatureMoveUpgradeList upgradeList, boolean isFirstInstance) {
    super(new ElbowSmash(), upgradeList, isFirstInstance);
  }
