...
public class ChopBlockMoveInfo extends AbstractSignatureMoveInfo {
  private static final int NUM_CARDS_REQUIRED = 5;
  private int numCardsExhausted = 0;
  private boolean alreadyGainedThisCombat;

  public ChopBlockMoveInfo() {
    this(SignatureMoveUpgradeList.NO_UPGRADES, true);
  }

  public ChopBlockMoveInfo(SignatureMoveUpgradeList upgradeList, boolean isFirstInstance) {
    super(new ChopBlock(), upgradeList, isFirstInstance);
  }
