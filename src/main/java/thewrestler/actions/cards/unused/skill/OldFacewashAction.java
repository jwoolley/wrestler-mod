package thewrestler.actions.cards.unused.skill;
...
import thewrestler.actions.cards.skill.FacewashDiscardAction;

public class OldFacewashAction extends AbstractGameAction  {
  private AbstractPlayer player;
  private static final float DURATION = Settings.ACTION_DUR_XFAST;
  private boolean cardDrawFinished;

  public OldFacewashAction(int cardDrawAmount) {
