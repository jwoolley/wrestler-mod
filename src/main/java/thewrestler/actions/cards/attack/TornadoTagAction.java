...
public class TornadoTagAction extends AbstractGameAction {
  ...
  public TornadoTagAction(AbstractPlayer player, AbstractCreature target, int baseDamage, int numRepetitions,
    ...
    if (this.duration < 0.0F)
    {
      if (this.target.currentHealth > 0)
      {
        ...
        AbstractDungeon.actionManager.addToBottom(
            new DamageAction(target, new DamageInfo(this.player, this.info.base), AttackEffect.SLASH_VERTICAL));
      }
